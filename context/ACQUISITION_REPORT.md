...
- [NCEI DART event page](https://www.ngdc.noaa.gov/hazard/dart/2011honshu_dart.html): source-defined near-field stations are 21418 and 21413. Pre-residual geographic far-field stations are 46411 (northeast Pacific) and 32401 (southeast Pacific). The documented ten-field layout conflicts with an observed eleventh token in sampled rows; it is retained as an unnamed source extra and is not interpreted.
...
| DART observations | 21418, 21413, 46411, 32401 | Selection precedes residual inspection. Times are UTC calendar/Julian fields; water-column series are meters. |
